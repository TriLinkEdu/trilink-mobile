class DummyData {
  ...
  static Map<String, dynamic> get classAttendanceAnalytics => {
    ...
    'overview': {
      'totalSessions': 24,
      'totalMarks': 720,
      'statusCounts': {'present': 648, 'absent': 40, 'late': 22, 'excused': 10},
    },
  ...
  static List<dynamic> get announcements => [
    {
      ...
      'message':
          'The mid-term examination schedule for all grades has been published. Please check the calendar for exact dates and rooms.',
    ...
    },
    {
      ...
      'message':
          'The school will be closed on April 8th for the national holiday. Classes resume on April 9th.',
      'targetAudience': ['student', 'teacher', 'parent'],
      'status': 'published',
    ...
    },
    {
      ...
      'message':
          'Starting April 1st, the library will remain open until 6:00 PM on weekdays. Weekend hours unchanged.',
    ...
    },
    {
      ...
      'message':
          'Register for the upcoming Sports Day events. Deadline: April 12th. Contact your PE teacher.',
  ...
  static List<dynamic> messages(String conversationId) => [
    ...
    },
    {
      ...
      'senderId': 'teacher-001',
      'text':
          'Yes, chapters 1 through 5. Focus on the exercises at the end of each chapter.',
      'createdAt': DateTime.now()
  ...
  static List<dynamic> get teacherFeedbackList => [
    ...
    },
    {
      ...
      'category': 'teacher',
      'message':
          'My child really enjoys your classes. Thank you for the extra support!',
      'status': 'open',
      'teacherId': 'teacher-001',
      'subjectId': null,
      'isAnonymous': false,
  ...
  static Map<String, dynamic> studentCompare(String studentId) => {
    ...
    'notes':
        'Overall improvement of 1.8 points. Strong progress in Mathematics and Physics.',
  };
  ...
  static Map<String, dynamic> studentProfile(String userId) => {
    ...
    'classes': [
      ...
      },
      {
        'subject': 'Chemistry',
        'teacher': 'Ms. Helen Tadesse',
        'schedule': 'Mon/Wed 11:00',
        'room': 'Lab 102',
      },
      {
        'subject': 'English',
        'teacher': 'Mr. John Peters',
        'schedule': 'Tue/Thu 9:00',
        'room': '108',
      },
      {
        'subject': 'History',
  ...
  static Map<String, dynamic> attemptForGrader(String attemptId) => {
    ...
    'answers': [
      ...
      {
        'questionText': 'Explain covalent bonding.',
        'answer':
            'Covalent bonding is the sharing of electrons between atoms...',
        'points': 10,
      },
      {
        'questionText': 'Balance: H2 + O2 → H2O',
        'answer': '2H2 + O2 → 2H2O',
        'points': 8,
      },
    ],
  ...
  static List<dynamic> childEnrollments(String studentId) => [
    {
      ...
      'grade': 'Grade 9',
      'section': 'A',
      'subject': {'id': 'sub-001', 'name': 'Mathematics', 'code': 'MATH-9'},
      'teacher': {
        'id': 'teacher-001',
        'firstName': 'Sara',
        'lastName': 'Ahmed',
    ...
    },
    {
      ...
      'grade': 'Grade 9',
      'section': 'A',
      'subject': {'id': 'sub-002', 'name': 'Physics', 'code': 'PHY-9'},
      'teacher': {
        'id': 'teacher-002',
        'firstName': 'Dawit',
        'lastName': 'Lemma',
    ...
    },
    {
      ...
      'grade': 'Grade 9',
      'section': 'A',
      'subject': {'id': 'sub-003', 'name': 'Chemistry', 'code': 'CHEM-9'},
      'teacher': {
        'id': 'teacher-003',
        'firstName': 'Helen',
        'lastName': 'Tadesse',
    ...
    },
    {
      ...
      'grade': 'Grade 9',
      'section': 'A',
      'subject': {'id': 'sub-004', 'name': 'English', 'code': 'ENG-9'},
      'teacher': {
        'id': 'teacher-004',
        'firstName': 'John',
        'lastName': 'Peters',
    ...
    },
    {
      ...
      'grade': 'Grade 9',
      'section': 'A',
      'subject': {'id': 'sub-005', 'name': 'History', 'code': 'HIST-9'},
      'teacher': {
        'id': 'teacher-005',
        'firstName': 'Rahel',
        'lastName': 'Mengistu',
    ...
    },
    {
      ...
      'grade': 'Grade 9',
      'section': 'A',
      'subject': {'id': 'sub-006', 'name': 'Biology', 'code': 'BIO-9'},
      'teacher': {
        'id': 'teacher-006',
        'firstName': 'Meron',
        'lastName': 'Bekele',
  ...
  static List<dynamic> childGoals(String studentId) => [
    {
      ...
      'description':
          'Practice algebra problems for 30 minutes daily and complete all homework assignments on time.',
    ...
    },
    {
      ...
      'description':
          'Complete and present a science fair project on renewable energy.',
    ...
    },
    {
      ...
      'title': 'Read 10 Books',
      'description':
          'Read at least 10 books this semester to improve reading comprehension.',
      'targetDate': '2026-06-30',
      'status': 'active',
      'progressPercent': 40,
  ...
  static List<dynamic> get parentNotifications => [
    {
      ...
      'payloadJson':
          '{"studentId":"stu-001","date":"2026-04-08","subject":"Mathematics"}',
      'readAt': null,
      'createdAt': DateTime.now()
          .subtract(const Duration(hours: 2))
          .toIso8601String(),
    },
    {
      ...
      'body':
          'Ali\'s Chemistry Final exam result has been released. Score: 87/100',
    ...
    },
    {
      ...
      'body':
          'Parent-Teacher conference scheduled for April 10, 2026 at 2:00 PM.',
    ...
    },
    {
      ...
      'payloadJson':
          '{"studentId":"stu-001","subject":"Mathematics","grade":92}',
      'readAt': DateTime.now()
  ...
  static List<dynamic> get parentAnnouncements => [
    {
      ...
      'message':
          'The parent-teacher conferences will be held on April 10-12. Please check your email for your scheduled time slot.',
    ...
    },
    {
      ...
      'message':
          'Reminder: Second semester fees are due by April 15, 2026. Please visit the finance office or pay online.',
      'targetAudience': ['parent'],
      'status': 'published',
    ...
    },
    {
      ...
      'message':
          'You are invited to attend the annual Science Fair on April 15, 2026 from 8:00 AM to 3:00 PM in the school auditorium.',
    ...
    },
    {
      ...
      'message':
          'The school calendar has been updated with new exam dates. Please check the calendar section for details.',
  ...
  static Map<String, dynamic> periodComparisonReport(String studentId) => {
    ...
    'period1': {
      ...
      'exams': {'count': 3, 'averageScore': 85.3},
      'termAverage': 87.5,
    },
    'period2': {
      'start': '2026-02-16',
      ...
      'exams': {'count': 4, 'averageScore': 88.5},
      'termAverage': 89.3,
    },
    'comparison': {
  ...
  static List<dynamic> get parentCalendarEvents => [
    {
      ...
      'type': 'meeting',
      'description':
          'Individual parent-teacher meetings to discuss student progress.',
    ...
    },
    {
      ...
      'type': 'event',
      'description':
          'Annual school science fair. Parents are welcome to attend.',
      'classOfferingId': null,
      'createdById': 'admin-001',
      'createdAt': '2026-03-20T09:00:00Z',
