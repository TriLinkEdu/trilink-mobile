...
class _ParentSettingsScreenState extends State<ParentSettingsScreen> {
  ...
  String get _role => AuthService().currentRole ?? 'parent';

  String get _rolePreferencesTitle {
    switch (_role) {
      case 'student':
  ...
  RoleThemeFlavor get _roleFlavor {
    switch (_role) {
      case 'student':
        return RoleThemeFlavor.student;
      case 'teacher':
        return RoleThemeFlavor.teacher;
      default:
        return RoleThemeFlavor.parent;
    }
  }

  bool get _showSoundEffects => _role != 'teacher';
