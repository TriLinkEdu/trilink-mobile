...
class _LeaderboardView extends StatelessWidget {
  ...
  static const String _myStudentId = 's1';
        ...
        child: BlocBuilder<LeaderboardCubit, LeaderboardState>(
          builder: (context, state) {
            ...
            final yourRank = entries.firstWhere(
              (entry) => entry.studentId == _myStudentId,
            ...
            final teamProgress =
                entries.take(5).fold<int>(0, (sum, e) => sum + e.points) / 2500;
            ...
            return ListView(
              ...
              children: [
                ...
                ...List.generate(entries.length, (index) {
                  ...
                  final isMe = entry.studentId == _myStudentId;
                  final rankColor = _rankAccent(entry.rank);
                  final gapFromLeader = (leader.points - entry.points).clamp(
                    0,
                    9999,
                  );
